...
type FakeGlobalTrafficPolicies struct {
	Fake *FakeGlobaltrafficpolicyV1alpha1
	ns   string
}

var globaltrafficpoliciesResource = schema.GroupVersionResource{Group: "globaltrafficpolicy", Version: "v1alpha1", Resource: "globaltrafficpolicies"}

var globaltrafficpoliciesKind = schema.GroupVersionKind{Group: "globaltrafficpolicy", Version: "v1alpha1", Kind: "GlobalTrafficPolicy"}

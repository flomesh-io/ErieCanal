...
```shell
helm install --namespace erie-canal --create-namespace --set ec.version=0.1.1-alpha.2-dev --set ec.logLevel=5 --set ec.serviceLB.enabled=true erie-canal charts/erie-canal/
```

...
```shell
helm install --namespace erie-canal --create-namespace --set ec.version=0.1.0-beta.4-dev --set ec.logLevel=5 --set ec.serviceLB.enabled=true erie-canal charts/erie-canal/
```
